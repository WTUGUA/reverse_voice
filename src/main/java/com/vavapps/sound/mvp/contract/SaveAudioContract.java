package com.vavapps.sound.mvp.contract;
 ...
 * ================================================
 */
public interface SaveAudioContract {
    ...
    interface Model extends IModel {
        Long saveAudio(AudioEntity audioEntity);
        Long saveAudioAndShare(AudioEntity audioEntity);
    }
}
